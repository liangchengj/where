...
extern "C"
{
	...
	{
		if (debug == JNI_TRUE)
			__android_log_print(ANDROID_LOG_ERROR, (MEYOU + jStrToCStr(env, tag_)).c_str(), "%s",
	...
	{
		if (debug == JNI_TRUE)
			__android_log_print(ANDROID_LOG_DEBUG, (MEYOU + jStrToCStr(env, tag_)).c_str(), "%s",
								jStrToChars(env, message_));
	}
	...
	{
		if (debug == JNI_TRUE)
			__android_log_print(ANDROID_LOG_INFO, (MEYOU + jStrToCStr(env, tag_)).c_str(), "%s",
								jStrToChars(env, message_));
	}
